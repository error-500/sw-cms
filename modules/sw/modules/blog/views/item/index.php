...
<div class="panel panel-flat">
    <div class="panel-body">
        <?= Html::a('<b><i class="icon-plus-circle2"></i></b> Добавить', ['/sw/blog/item/create'], ['class' => 'btn bg-teal-400 btn-labeled']) ?>
        <hr>
                ...
                [
                    ...
                    'buttons' => [
                        'update' => function ($url, $model) {
                            return Html::a('<i class="icon-pencil"></i>', ['/sw/blog/item/update', 'id' => $model->id]);
                        },
                        'delete' => function ($url, $model) {
                            return Html::a('<i class="icon-trash"></i>', ['/sw/blog/item/delete', 'id' => $model->id], [
                                'data' => [
